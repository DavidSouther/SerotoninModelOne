...
class TwoColumnNetwork(Network):
    def __init__(self, tau, parentSimulation, params, name):
        ...
        self.populations["lowThresholdsA"] = Population(self.tau, ltsParams, self.popCount, [factorySomatic5HT2A, factorySomatic5HT1A], transmittersA, self, "Area A Low Threshold Cells")
        ...
        self.populations["lowThresholdsB"] = Population(self.tau, ltsParams, self.popCount, [factorySomatic5HT2A, factorySomatic5HT1A], transmittersB, self, "Area B Low Threshold Cells")
