...
for i in range(10):
    print(i)
    with open("TwoColumnPicklePharma" + str(i) + ".jar", "rb") as pickleJar:
            sim = dill.load(pickleJar)
            ...
            # np.append(arrBRate, sim.network.populations["InputB"].rateRecord, axis=1)
...
plt.ylim(0, 4000)
plt.savefig("A_Input_CI_Pharma.pdf")
plt.savefig("A_Input_CI_Pharma.png")

plt.figure(figsize=(9.37,2.58))
plt.pcolor([c.vv for c in sim.network.populations["InputA"].cells], vmin=-80, vmax=60, cmap="Greys")
plt.savefig("Raster_A_Input_Pharma.pdf")
plt.savefig("Raster_A_Input_Pharma.png")
...
plt.plot(meanARate)
plt.ylim(0, 4000)
plt.savefig("A_Pyramidal_CI_Pharma.pdf")
plt.savefig("A_Pyramidal_CI_Pharma.png")

plt.figure(figsize=(9.37,2.58))
plt.pcolor([c.vv for c in sim.network.populations["pyramidalsA"].cells], vmin=-80, vmax=60, cmap="Greys")
plt.savefig("Raster_A_Pyramidals_Pharma.pdf")
plt.savefig("Raster_A_Pyramidals_Pharma.png")
...
plt.ylim(0, 4000)
plt.savefig("A_FS_CI_Pharma.pdf")
plt.savefig("A_FS_CI_Pharma.png")

plt.figure(figsize=(9.37,2.58))
plt.pcolor([c.vv for c in sim.network.populations["fastSpikingsA"].cells], vmin=-80, vmax=60, cmap="Greys")
plt.savefig("Raster_A_FS_Pharma.pdf")
plt.savefig("Raster_A_FS_Pharma.png")
...
plt.ylim(0, 4000)
plt.savefig("A_LTS_CI_Pharma.pdf")
plt.savefig("A_LTS_CI_Pharma.png")

plt.figure(figsize=(9.37,2.58))
plt.pcolor([c.vv for c in sim.network.populations["lowThresholdsA"].cells], vmin=-80, vmax=60, cmap="Greys")
plt.savefig("Raster_A_LTS_Pharma.pdf")
plt.savefig("Raster_A_LTS_Pharma.png")
...
plt.ylim(0, 4000)
plt.savefig("B_Input_CI_Pharma.pdf")
plt.savefig("B_Input_CI_Pharma.png")
...
plt.plot(meanBRate)
plt.ylim(0, 4000)
plt.savefig("B_Pyramidal_CI_Pharma.pdf")
plt.savefig("B_Pyramidal_CI_Pharma.png")
...
plt.ylim(0, 4000)
plt.savefig("B_FS_CI_Pharma.pdf")
plt.savefig("B_FS_CI_Pharma.png")
...
plt.ylim(0, 4000)
plt.savefig("B_LTS_CI_Pharma.pdf")
plt.savefig("B_LTS_CI_Pharma.png")
...
plt.savefig("A_Influence_CI_Pharma.pdf")
plt.savefig("A_Influence_CI_Pharma.png")
...
plt.savefig("B_Influence_CI_Pharma.pdf")
plt.savefig("B_Influence_CI_Pharma.png")
